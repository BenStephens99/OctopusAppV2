...
function createStatusBox(house) {
    ...
    document.getElementById('graphs').innerHTML += '<div onclick="changeProperty(' + house.postcode + ')" class="statusBox"><h4>' + house.address + '</h4> <div class="dataBox"><p>£' + addAllValues(gasToPound(house)) + '</p><p class="gasCol">Gas:</p></div> <div class="dataBox"><p>£' + addAllValues(electToPound(house)) + '</p><p class="elecCol">Electric:</p></div></div>'
}
